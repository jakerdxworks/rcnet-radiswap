...
export declare class Address extends Value implements IAddress {
    ...
    static ecdsaSecp256k1TokenResourceAddress(networkId: number): Promise<Address>;
    static eddsaEd25519TokenResourceAddress(networkId: number): Promise<Address>;
    static packageTokenResourceAddress(networkId: number): Promise<Address>;
    static epochManagerComponentAddress(networkId: number): Promise<Address>;
    static clockComponentAddress(networkId: number): Promise<Address>;
...
export declare class Reference extends Value {
    value: Uint8Array;
    constructor(value: Uint8Array);
    toString(): string;
    toObject(): Record<string, any>;
