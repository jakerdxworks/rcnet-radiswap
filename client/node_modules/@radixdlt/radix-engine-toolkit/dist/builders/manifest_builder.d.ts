...
export declare class ManifestBuilder {
     ...
     */
    callFunction(packageAddress: ManifestAstValue.Address | string, blueprintName: ManifestAstValue.String | string, functionName: ManifestAstValue.String | string, args: Array<ManifestAstValue.Value> | null): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    callMethod(componentAddress: ManifestAstValue.Address | string, methodName: ManifestAstValue.String | string, args: Array<ManifestAstValue.Value> | null): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    takeFromWorktop(resourceAddress: ManifestAstValue.Address | string, andThen: (builder: ManifestBuilder, bucket: ManifestAstValue.Bucket) => ManifestBuilder): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    takeFromWorktopByAmount(resourceAddress: ManifestAstValue.Address | string, amount: Decimal | number | string | ManifestAstValue.Decimal, andThen: (builder: ManifestBuilder, bucket: ManifestAstValue.Bucket) => ManifestBuilder): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    takeFromWorktopByIds(resourceAddress: ManifestAstValue.Address | string, ids: Array<ManifestAstValue.NonFungibleLocalId>, andThen: (builder: ManifestBuilder, bucket: ManifestAstValue.Bucket) => ManifestBuilder): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    assertWorktopContains(resourceAddress: ManifestAstValue.Address | string): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    assertWorktopContainsByAmount(resourceAddress: ManifestAstValue.Address | string, amount: Decimal | number | string | ManifestAstValue.Decimal): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    assertWorktopContainsByIds(resourceAddress: ManifestAstValue.Address | string, ids: Array<ManifestAstValue.NonFungibleLocalId>): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createProofFromAuthZone(resourceAddress: ManifestAstValue.Address | string, andThen: (builder: ManifestBuilder, bucket: ManifestAstValue.Proof) => ManifestBuilder): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createProofFromAuthZoneByAmount(resourceAddress: ManifestAstValue.Address | string, amount: Decimal | number | string | ManifestAstValue.Decimal, andThen: (builder: ManifestBuilder, bucket: ManifestAstValue.Proof) => ManifestBuilder): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createProofFromAuthZoneByIds(resourceAddress: ManifestAstValue.Address | string, ids: Array<ManifestAstValue.NonFungibleLocalId>, andThen: (builder: ManifestBuilder, bucket: ManifestAstValue.Proof) => ManifestBuilder): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    publishPackage(code: Uint8Array | string, schema: Uint8Array | string, royaltyConfig: ManifestAstValue.Map, metadata: ManifestAstValue.Map, accessRules: ManifestAstValue.Value): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    recallResource(vaultId: ManifestAstValue.Bytes, amount: Decimal | number | string | ManifestAstValue.Decimal): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    setPackageRoyaltyConfig(packageAddress: ManifestAstValue.Address | string, royaltyConfig: ManifestAstValue.Map): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    setComponentRoyaltyConfig(componentAddress: ManifestAstValue.Address | string, royaltyConfig: ManifestAstValue.Tuple): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    setMethodAccessRule(entityAddress: ManifestAstValue.Address | string, key: ManifestAstValue.Tuple, rule: ManifestAstValue.Enum): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createFungibleResource(divisibility: ManifestAstValue.U8, metadata: ManifestAstValue.Map, accessRules: ManifestAstValue.Map): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createFungibleResourceWithInitialSupply(divisibility: ManifestAstValue.U8, metadata: ManifestAstValue.Map, accessRules: ManifestAstValue.Map, initialSupply: Decimal | number | string | ManifestAstValue.Decimal): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createNonFungibleResource(idType: ManifestAstValue.Enum, schema: ManifestAstValue.Tuple, metadata: ManifestAstValue.Map, accessRules: ManifestAstValue.Map): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createNonFungibleResourceWithInitialSupply(idType: ManifestAstValue.Enum, schema: ManifestAstValue.Tuple, metadata: ManifestAstValue.Map, accessRules: ManifestAstValue.Map, initialSupply: ManifestAstValue.Value): ManifestBuilder;
    /**
     ...
     * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
     */
    createValidator(key: ManifestAstValue.Bytes, ownerAccessRule: ManifestAstValue.Enum): ManifestBuilder;
    /**
